...
import net.ssehub.kernel_haven.srcml_old.transformation.CodeUnit;
...
import net.ssehub.kernel_haven.srcml_old.transformation.PreprocessorBlock.Type;
import net.ssehub.kernel_haven.srcml_old.transformation.PreprocessorElse;
import net.ssehub.kernel_haven.srcml_old.transformation.PreprocessorEndIf;
import net.ssehub.kernel_haven.srcml_old.transformation.PreprocessorIf;
...
public class PreprocessorTranslation implements ITransformationRule {
    ...
    private @NonNull Deque<PreprocessorIf> parents = new ArrayDeque<>();
